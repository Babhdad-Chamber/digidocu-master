...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">لوحة التحكم</h1>
    </section>
            ...
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header no-border text-center">
                        <h3 class="box-title">تحميل سريع</h3>
                    ...
                    <div class="box-body">
                        <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                            <div class="form-group">
                                <label for="">اختر {{ucfirst(config('settings.document_label_singular'))}}</label>
